...
wp_enqueue_style('yeseva', get_theme_file_uri('/font-yeseva/font-yeseva.css'));
...
// for footer
function beauchamp_stylesheets_footer() {
	...
	// if(!is_page(81)) {
		wp_enqueue_script('blank-space-js', get_theme_file_uri('/js/blank-space.js'));
	// }
...
add_action('get_footer', 'beauchamp_stylesheets_footer');
...
add_action('after_setup_theme', 'beauchamp_menus');
